...
const (
	LeaderboardStatService_GetContributorStats_FullMethodName  = "/leaderboardstat.LeaderboardStatService/GetContributorStats"
	LeaderboardStatService_GetPublicLeaderboard_FullMethodName = "/leaderboardstat.LeaderboardStatService/GetPublicLeaderboard"
)
...
func (c *leaderboardStatServiceClient) GetPublicLeaderboard(ctx context.Context, in *GetPublicLeaderboardRequest, opts ...grpc.CallOption) (*GetPublicLeaderboardResponse, error) {
	...
	err := c.cc.Invoke(ctx, LeaderboardStatService_GetPublicLeaderboard_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _LeaderboardStatService_GetPublicLeaderboard_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LeaderboardStatService_GetPublicLeaderboard_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {

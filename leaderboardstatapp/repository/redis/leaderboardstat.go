...
func (d DB) GetScoreboardByFilters(ctx context.Context, page int, pageSize int, category string, timeframe string) (leaderboardstat.ScoreboardResponse, error) {
	...
	return response, nil
	/*
		global|project:{timeframe}:time-value

		global:week:2018-w3
		cdp:month:2018-m5
		eebi:year:2018
		beehive:week:2018-w3
		mapserver:week:2018-w3
		rankr:week:2018-w3

...
CREATE TABLE IF NOT EXISTS tasks (
    ...
    version_control_system_id BIGINT NOT NULL UNIQUE,
...
CREATE INDEX idx_tasks_version_control_system_id ON tasks(version_control_system_id);

-- +migrate Down
DROP INDEX IF EXISTS idx_tasks_version_control_system_id;

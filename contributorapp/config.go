...
import (
	...
	"github.com/gocasters/rankr/contributorapp/job"
...
type Config struct {
	...
	DashboardValidate    job.Config        `koanf:"job_validate" json:"job_validate"`
	DashboardConfig      job.ConfigJob     `koanf:"job_config" json:"job_config"`
}

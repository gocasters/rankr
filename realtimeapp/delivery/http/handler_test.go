...
func TestHandler_WebSocketSubscribe(t *testing.T) {
	...
	subscribeMsg := realtime.Message{
		Type: realtimeconstant.MessageTypeSubscribe,
	...
	assert.Equal(t, realtimeconstant.MessageTypeAck, response["type"])
...
func TestHandler_WebSocketUnsubscribe(t *testing.T) {
	...
	unsubscribeMsg := realtime.Message{
		Type: realtimeconstant.MessageTypeUnsubscribe,
		Payload: map[string]interface{}{
	...
	assert.Equal(t, realtimeconstant.MessageTypeAck, unsubscribeResp["type"])
...
func TestHandler_WebSocketInvalidMessage(t *testing.T) {
	...
	assert.Equal(t, realtimeconstant.MessageTypeError, response["type"])
...
func TestHandler_SendError(t *testing.T) {
	...
	case msg := <-client.Send:
		...
		require.NoError(t, err)
		assert.Equal(t, realtimeconstant.MessageTypeError, errorMsg.Type)
...
func TestHandler_SendResponse(t *testing.T) {
	...
	handler.sendResponse(client, realtimeconstant.MessageTypeAck, payload)
